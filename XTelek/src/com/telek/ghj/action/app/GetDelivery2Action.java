...
public class GetDelivery2Action extends HttpServlet {


	private static final long serialVersionUID = 1017880314556832455L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				Map<String, Object> jsonMap=deliveryService.getDelivery2(stationname,page,rows);
