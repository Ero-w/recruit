...
public class GetDeleiveryListAction extends HttpServlet {

	private static final long serialVersionUID = -8666244057227658025L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				Map<String, Object> jsonMap=deliveryService.getDeliverySituation(stationname,page,rows);
